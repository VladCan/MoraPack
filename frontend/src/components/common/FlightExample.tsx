// src/components/FlightExample.tsx
...
// ====== Ejemplo con toolbar ======
export default function FlightExample() {
  ...
  const planeNext = useMemo(() => slerpOnSphere(ORIGIN, DEST, Math.min(1, progress + 0.002)), [progress]);
  ...
  return (
    <div className="w-full h-screen">
      ...
      >
        ...
        <div style={{ fontSize: 12, opacity: 0.7 }}>Progreso: {(progress * 100).toFixed(0)}%</div>
      </div>
      ...
      <Map
        ...
        minZoom={projection === "mercator" ? 1.6 : 2.3}
      >
